        ...
        <div className="p-4 flex-1 flex flex-col gap-4 overflow-hidden">
          ...
          <div className="flex gap-4 items-end">
            <div className="flex-1">
              <label className="block text-sm font-bold mb-1">Scan Accession Barcode:</label>
              <form onSubmit={handleScan} className="flex gap-2">
                <input
                  ...
                  disabled={!isScanning}
                  className="flex-1 h-8 px-2 border-2 border-inset bg-white focus:outline-none font-mono"
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-scroll bg-white border-2 border-inset border-gray-400">
              {scannedItems.length === 0 ? (
                ...
                scannedItems.map((item, idx) => (
                  <div 
                    ...
                    className={`flex text-xs p-1 border-b border-gray-100 items-center ${idx === 0 ? 'bg-blue-50' : ''}`}
                  >
                    ...
                    <div className="w-32 px-1 text-right text-gray-500">
